    ...
    <>
      <div className="min-h-screen text-neutral-700 dark:text-neutral-200 flex">
        ...
        <aside className="lg:items-center items-start w-[14%] lg:w-[35%] justify-between h-screen flex px-3 lg:p-6">
          ...
          {/* Profile + language */}
          <div className="flex lg:-mt-32 mt-24 flex-col gap-0 lg:gap-3 items-start lg:items-center">
        ...
        <main className="flex-1 p-5 lg:p-20 w-[65%] mt-20 lg:mt-2 overflow-auto h-screen">
          ...
          >
            ...
            <span className="text-sm lg:text-base text-neutral-20d0">Schedule a call</span>
          ...
          <div className="mb-8">
            ...
            <div className='flex space-x-2 lg:space-x-3 overflow-x-auto -ml-1'>
              {[
                ...
                {name: "Facebook", icon: <SiFacebook/>, link: "https://web.facebook.com/profile.php?id=100085870614623"},
                {name: "Instagram", icon: <SiInstagram/>, link: "https://www.instagram.com/prosper_samuel55/"},
              ].map((social, i) => (
                <a href={social.link} 
                target="_blank"
                rel="noopener noreferrer"
                 key={i} className="flex items-center mb-6 px-2 border border-neutral-100 dark:border-neutral-700 bg-neutral-100 shadow-md dark:bg-gradient-to-br from-neutral-700 to-neutral-900 dark:from-neutral-700 dark:to-neutral-900 hover:scale-110 duration-300 transition rounded-full w-fit py-1 gap-1.5">
          ...
          <section id="introduction" ref={sectionRefs.introduction} className="mb-8">
          ...
          <section id="work" ref={sectionRefs.work} className="mb-8">
          ...
          <section id="skills" ref={sectionRefs.skills} className="mb-8">
